...
public class Servicos {
    ...
    private By segundoTextoAlocacaoProfissionais = By.xpath("//*[@id=\"wrapper\"]/div[2]/div/div/div/div/div[3]/div/p[1]");
    private By imgAlocacaoProfissionais = By.xpath("//*[@id=\"wrapper\"]/div[2]/div/div/div/div/div[3]/div/p[2]/img");
    ...
    private By primeiroTextoAutomacaoProcessos = By.xpath("//*[@id=\"wrapper\"]/div[2]/div/div/div/div/div[2]/div/p[1]");
    private By segundoTextoAutomacaoProcessos = By.xpath("//*[@id=\"wrapper\"]/div[2]/div/div/div/div/div[2]/div/p[2]");
    private By terceiroTextoAutomacaoProcessos = By.xpath("//*[@id=\"wrapper\"]/div[2]/div/div/div/div/div[2]/div/p[3]");
    ...
    public void clicarLinkRodapeFabricaDeTestes() {
        driver.findElement(linkRodapeFabricaDeTestes).click();
    }

    public void clicarLinkRodapeAutomatizacaoDeTestes() {
        driver.findElement(linkRodapeAutomatizacaoDeTestes).click();
    }

    public void clicarLinkRodapeTestesMobile() {
        driver.findElement(linkRodapeTestesMobile).click();
    }

    public void clicarLinkRodapeTestesManuais() {
        driver.findElement(linkRodapeTestesManuais).click();
    }

    public void clicarLinkRodapeTestesFuncionaisENaoFuncionais() {
        driver.findElement(linkRodapeTestesFuncionaisENaoFuncionais).click();
    }

    public void clicarLinkRodapeAlocacaoDeProfissionais() {
        driver.findElement(linkRodapeAlocacaoDeProfissionais).click();
    }

    public void clicarLinkRodapeAutomacaoDeProcessos() {
        driver.findElement(linkRodapeAutomacaoDeProcessos).click();
    }

    public void clicarLinkRodapeCrowdsourcedAuditeste() {
        driver.findElement(linkRodapeCrowdsourcedAuditeste).click();
    }

    public void clicarLinkRodapeConsultoria() {
        driver.findElement(linkRodapeConsultoria).click();
    }
    ...
    public String obterSegundoTextoAlocacaoProfissionais() {
        return driver.findElement(segundoTextoAlocacaoProfissionais).getText();
    }

    public boolean visualizarImgAlocacaoProfissionais() {
        return driver.findElement(imgAlocacaoProfissionais).isDisplayed();
    }
